...
model = load_model(r'D:\Matakuliah Semester 5\Pembelajaran Mesin dan Pembelajaran Mendalam\CNN\Tugas6_A_11777\model_googlenet.h5')
...
st.title("Prediksi Kematangan Buah Naga - 1777")
